...
public class J8P {
    ...
    public static final Stack<Node> pilha = new Stack<>();
    public static final HashSet<Node> visitados = new HashSet<>();

    public static Node procura(int[][] solucao, Node no) {
        pilha.add(no);
        while (!pilha.isEmpty()) {
            Node novo_no = pilha.pop();
    ...
    public static void expandir(Node no) {
    ...
    public static void caminho(Node no) {
        ...
        while (nodeToPrint != null) {
            imprimeMATRIX(nodeToPrint.estado);
            System.out.println("profundidade:" + nodeToPrint.profundidade);
            System.out.println("jogada:" + nodeToPrint.jogada);
            nodeToPrint = nodeToPrint.pai;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Node no = new Node(estado_inicial, null, 'n', 0, posBRANCO(estado_inicial), 0);
